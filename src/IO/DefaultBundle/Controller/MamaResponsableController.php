...
class MamaResponsableController extends BaseController {
    ...
    public function indexAction() {
        $list = array(
            array('id' => 1, 'title' => "LE TITRE",
                'short' => "Principe de présentation de photo",
                'img' => "bundles/iodefault/images/vignette-1.jpg",
        ...
        return $this->render('IODefaultBundle:MamaResponsable:index.html.twig', array('articles' => $list));
    }
